...
from ReneeMontoyaApp_from_fix.models.models import Plant, Employee


class TestPlant(unittest.TestCase):
    @patch('ReneeMontoyaApp_from_fix.models.models.Plant.get_file_data')
    ...
    @patch('ReneeMontoyaApp_from_fix.models.models.Employee.get_by_id')
